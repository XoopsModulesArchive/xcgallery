<?php
// $Id: upload.php,v 1.1 2004/11/23 22:20:43 praedator Exp $
//  ------------------------------------------------------------------------ //
...
function form_alb_list_box()
{
    ...
    if (count($other_user_albums_list) > 0) {
        ...
        foreach ($other_user_albums_list as $album) {
            $alb_owner = $userHandler->getUser($album['category'] - FIRST_USER_CAT);
...
$GLOBALS['xoopsOption']['template_main'] = 'xcgal_upload.html';
require XOOPS_ROOT_PATH . '/header.php';

ob_start();
$GLOBALS['caption'] = htmlspecialchars('', ENT_QUOTES | ENT_HTML5);

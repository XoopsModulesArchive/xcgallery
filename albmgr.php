<?php
// $Id: albmgr.php,v 1.1 2004/11/23 22:15:08 praedator Exp $
//  ------------------------------------------------------------------------ //
...
$GLOBALS['xoopsOption']['template_main'] = 'xcgal_albmgr.html';
...
if (GALLERY_ADMIN_MODE) {
    ...
    $CAT_LIST[] = [FIRST_USER_CAT + USER_ID, _MD_ALBMGR_MY_GAL];

    $CAT_LIST[] = [0, _MD_ALBMGR_NO_CAT];

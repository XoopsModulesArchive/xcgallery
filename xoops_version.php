<?php
// $Id: xoops_version.php,v 1.1 2004/11/23 22:20:43 praedator Exp $
//  ------------------------------------------------------------------------ //
...
$modversion['description'] = 'Gallery module based on Coppermine 1.10 &copy; Grégory DEMAR (http://coppermine.sourceforge.net)';
$modversion['credits'] = 'myXoopsForge (http://www.myxoopsforge.org)';
$modversion['author'] = 'Derya Kiran (meeresstille@gmx.de) for Version 1RC1<br>Rest by Predator';
...
$modversion['demo_site_url'] = 'http://demoxcgal.xoops2.org';
$modversion['demo_site_name'] = 'xcGallery Demo';
$modversion['support_site_url'] = 'http://www.xoops2.org';
$modversion['support_site_name'] = 'xcGallery on Xoops2.org';
...
For the schinese and tchinese translation: phppp, chia and the Xoops China https://www.xoops.org.cn .<br>
<br><br>
...
// Templates
$modversion['templates'][1]['file'] = 'xcgal_upload.html';
$modversion['templates'][1]['description'] = '';
$modversion['templates'][2]['file'] = 'xcgal_index.html';
$modversion['templates'][2]['description'] = '';
$modversion['templates'][3]['file'] = 'xcgal_albmgr.html';
...
$modversion['templates'][9]['file'] = 'xcgal_header.html';
$modversion['templates'][9]['description'] = '';
$modversion['templates'][10]['file'] = 'xcgal_footer.html';
...
$modversion['config'][12]['options'] = ['_MI_SORT_NA' => 'na', '_MI_SORT_ND' => 'nd', '_MI_SORT_DA' => 'da', '_MI_SORT_DD' => 'dd'];
...
$modversion['config'][27]['default'] = 'GIF/PNG/JPG/JPEG/TIF/TIFF';
...
$modversion['config'][28]['default'] = 'gd1';
$modversion['config'][28]['options'] = ['Image Magick' => 'im', 'Netpbm' => 'net', 'GD version 1.x' => 'gd1', 'GD version 2.x' => 'gd2'];
...
$modversion['config'][43]['options'] = ['_MI_TEXT_CARD' => 1, '_MI_HTML_CARD' => 2];
